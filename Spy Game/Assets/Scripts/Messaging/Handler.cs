...
public class Handler : MonoBehaviour {
	...
	public void InitializeOptions()
	{
		...
		GameManager.manager.handlerOptionList.Add (new Options ("Who are you?", "What is this?", "Help with what?", "It doesn't matter right now, but suffice to say there's a large problem", "There's a lot to explain, and not much time.", "Let me take a moment to explain.", 0, 0, 0));
		...
		GameManager.manager.handlerOptionList.Add(new Options("What all can I do with her?", "Are you sure?", "I don't think I'm qualified for this.", "Simply direct her actions with the chat, as you've been doing so far.", "Quite clearly.", "Nonsense. It's quite simple.", 0, 0, 0));
